    ...
    require([
        ...
        function prepararTablaPriorizada(rawData, domainMap) {
            ...
            let partidas = [
                ...
                { nombre: "D. Ascensores, Escaleras y/o Circulaciones", p: getVal(rawData, "d_ponderado"), intervencion: getLabel("tipo_intervencion_escaleras", getVal(rawData, "tipo_intervencion_escaleras")) },
